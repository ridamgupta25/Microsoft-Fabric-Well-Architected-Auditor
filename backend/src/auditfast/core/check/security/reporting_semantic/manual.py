"""Security · Reporting / Semantic — manual / attestation checks (auto-generated).
...
_CHECKS: list[tuple[str, str, str, tuple[str, ...], bool, str]] = [
    ...
    ("M-6-2-1", "6.2.1", "Row-Level Security (RLS) implemented on Gold / Power BI semantic models", (Layer.REPORTING,), True, "ROADMAP"),
]
