"""Security · Data Storage — manual / attestation checks (auto-generated).
...
_CHECKS: list[tuple[str, str, str, tuple[str, ...], bool, str]] = [
    ...
    ("M-6-2-2", "6.2.2", "Column-Level Security / Object-Level Security applied for sensitive fields", (Layer.STORAGE, Layer.REPORTING), True, "ROADMAP"),
    ("M-6-2-5", "6.2.5", "OneLake data access controlled via workspace roles (not open access)", (Layer.STORAGE,), True, "ROADMAP"),
    ("M-6-2-6", "6.2.6", "Data exfiltration controls configured (copy/export/download restrictions on sensitive workspaces)", (Layer.STORAGE,), True, "ROADMAP"),
]
