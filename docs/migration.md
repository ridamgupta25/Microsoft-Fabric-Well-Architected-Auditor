...
> seven pillars, plus an on-disk knowledge-base cache. Figures and paths below
> are preserved as they were at migration time; see
> [architecture.md](architecture.md) and [checks.md](checks.md) for the current
> state.
